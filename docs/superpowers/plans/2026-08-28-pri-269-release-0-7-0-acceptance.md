...
- [ ] **Step 1: Проверить установку 0.7.0 из PyPI**
...
- [ ] **Step 2: Снять версии плагина в обоих клиентах**
...
- [ ] **Step 3: Проверить целостность codex-манифеста**
...
- [ ] **Step 4: Создать отчёт со скелетом и предусловиями**
