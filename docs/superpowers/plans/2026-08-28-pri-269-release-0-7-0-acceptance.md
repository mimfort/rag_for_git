...
- [x] **Step 1: Запросить санкцию на создание временного PR**
...
- [x] **Step 2: Подготовить ветку с осмысленным .py-диффом**
...
- [x] **Step 3: Открыть PR (санкция получена в шаге 1)**
...
- [x] **Step 4: Прогнать полный цикл ревью**
...
- [x] **Step 5: Диагностический поиск для проверки RRF**
...
- [x] **Step 6: Записать результат в раздел «Критерий 4» и закоммитить**
...
- [x] **Step 1: Снять baseline времени и полноты payload (серверный канал)**
...
- [x] **Step 2: Записать критерий 4 (живая часть)**
...
- [x] **Step 3: Прогнать eval replay в двух режимах сидирования**
...
- [x] **Step 4: Проверить сохранность ручного хвоста отчёта**
...
- [x] **Step 5: Проверить отказ на отчёте без маркера — до обращения к Voyage**
...
- [x] **Step 6: Запросить санкцию и снять замер исчерпания пула**
...
- [x] **Step 1: Снять watermark и выгрузить пачку задач ДО остановки**
...
- [x] **Step 2: Запросить санкцию и остановить хранилища**
...
- [x] **Step 3: Замерить prepare_task_context на мёртвом сторе (шаг 3, критерий 1)**
...
- [x] **Step 4: Замерить пачку задач на мёртвом сторе (шаг 4, критерий 2)**
...
- [x] **Step 5: Зафиксировать нулевой расход Voyage**
...
- [x] **Step 6: Пройти шаг 0a скиллом solve-task в режиме normal (шаг 5, критерий 5)**
...
- [x] **Step 8: Поднять хранилища обратно и записать результаты**
...
- [x] **Step 1: Запросить санкцию и остановить только Neo4j**
...
- [x] **Step 2: Снять payload при мёртвом Neo4j**
...
- [x] **Step 3: Классифицировать результат**
...
- [x] **Step 4: Поднять Neo4j и подтвердить восстановление**
...
- [x] **Step 1: Собрать три подменённых env-файла**
...
- [x] **Step 2: Снять замер при не-loopback эндпоинтах (шаг 7, критерий 3)**
...
- [x] **Step 3: Снять замеры при неверном пароле и несуществующей БД (шаг 11, критерий 8)**
...
- [x] **Step 4: Проверить клиентское поведение шага 0a при `remedy: null`**
...
- [x] **Step 5: Убедиться, что канонический env не тронут**
...
- [x] **Step 1: Подтвердить возврат в исправное состояние живым вызовом**
...
- [x] **Step 3: Свести найденные дефекты**
...
- [x] **Step 4: Запросить санкцию и завести задачи PRI**
...
- [x] **Step 5: Заполнить итог по 11 критериям**
...
- [x] **Step 7: Предложить закрытие задачи**
