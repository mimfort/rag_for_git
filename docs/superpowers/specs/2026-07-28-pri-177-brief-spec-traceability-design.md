...
Задача PRI-177 требовала дополнительно копировать секцию `## Constraints / open questions` из
брифа в спеку **verbatim**, обосновывая это тем, что «0 из 56 спек копируют Constraints ⇒
constraints потеряны». Проверка содержания это опровергает — задача измерила наличие
**заголовка**, а не наличие смысла:
