...
- `get_impact` — grounded caller candidates for changed signatures, including files changed by the PR; marks PR scope and reports unresolved graph IDs as coverage gaps;
