...
Прогон от 2026-08-20T20:02:47.191846+00:00, репозиторий `mimfort/rag_for_git`, ветка `dev`.

## Идентичность прогона

- **прогон**: вариант `baseline`, коммит `3e21f3cd3118e8e699dc886b6096487f3bc10037`, indexed_sha `a07405c7f11b029f30ae0be969fa36a009074ffb`, корпус 63

## Агрегат

| Метрика | Значение |
|---|---|
| core-recall (медиана) | 0.25 |
| core-recall (среднее) | 0.2563 |
| core-recall bulk (ядро ≥ 10) | 0.1429 |
| bulk N | 5 |
| context-recall (медиана) | 0 |
| context измерено | 31 |
| context без точки измерения | 16 |
| union-precision (медиана) | 1 |
| precision (медиана) | 1 |
| предсказано файлов (медиана) | 2 |
| задач измерено | 47 |
| без точки измерения | 0 |
...
| Ключ | Статус | core-recall | предсказано | попало | ctx | ctx_hit | ctx_recall | u_prec |
|---|---|---|---|---|---|---|---|---|
| PRI-162 | empty_core_denominator | — | 2 | 0 | 0 | 0 | — | 0 |
| PRI-164 | empty_core_denominator | — | 1 | 0 | 0 | 0 | — | 0 |
| PRI-196 | measured | 0.2 | 2 | 2 | 1 | 0 | 0 | 1 |
| PRI-176 | empty_core_denominator | — | 3 | 0 | 0 | 0 | — | 0 |
| PRI-202 | measured | 0.1111 | 2 | 1 | 0 | 0 | — | 1 |
| PRI-203 | empty_core_denominator | — | 1 | 0 | 0 | 0 | — | 0 |
| PRI-205 | measured | 0.2 | 1 | 1 | 0 | 0 | — | 1 |
| PRI-206 | empty_core_denominator | — | 2 | 0 | 0 | 0 | — | 0 |
| PRI-207 | measured | 0.1667 | 1 | 1 | 0 | 0 | — | 1 |
| PRI-208 | empty_core_denominator | — | 1 | 0 | 0 | 0 | — | 0 |
| PRI-209 | no_ground_truth | — | 0 | 0 | 0 | 0 | — | — |
| PRI-210 | measured | 0.5 | 2 | 1 | 2 | 0 | 0 | 1 |
| PRI-211 | measured | 0 | 3 | 0 | 0 | 0 | — | 0 |
| PRI-179 | measured | 0 | 4 | 0 | 1 | 0 | 0 | 0 |
| PRI-212 | measured | 0.5 | 3 | 1 | 0 | 0 | — | 0.3333 |
| PRI-172 | measured | 0 | 3 | 0 | 1 | 0 | 0 | 0.3333 |
| PRI-213 | measured | 0.2857 | 2 | 2 | 1 | 0 | 0 | 1 |
| PRI-215 | measured | 0.1429 | 3 | 2 | 11 | 0 | 0 | 1 |
| PRI-216 | empty_core_denominator | — | 2 | 0 | 0 | 0 | — | 0 |
| PRI-217 | measured | 0.25 | 4 | 1 | 7 | 1 | 0.1429 | 0.75 |
| PRI-218 | measured | 1 | 2 | 1 | 0 | 0 | — | 1 |
| PRI-173 | measured | 0.5 | 2 | 2 | 2 | 0 | 0 | 1 |
| PRI-175 | no_ground_truth | — | 0 | 0 | 0 | 0 | — | — |
| PRI-177 | measured | 0 | 3 | 0 | 0 | 0 | — | 0 |
| PRI-219 | measured | 0.25 | 3 | 1 | 3 | 1 | 0.3333 | 0.6667 |
| PRI-220 | empty_core_denominator | — | 3 | 0 | 0 | 0 | — | 0 |
| PRI-134 | measured | 0.5 | 3 | 2 | 2 | 0 | 0 | 1 |
| PRI-178 | measured | 1 | 2 | 1 | 0 | 0 | — | 0.5 |
| PRI-221 | measured | 0 | 1 | 0 | 10 | 0 | 0 | 1 |
| PRI-225 | measured | 0.1667 | 3 | 3 | 2 | 0 | 0 | 1 |
| PRI-226 | no_ground_truth | — | 0 | 0 | 0 | 0 | — | — |
| PRI-227 | measured | 0 | 4 | 0 | 0 | 0 | — | 0 |
| PRI-224 | no_ground_truth | — | 0 | 0 | 0 | 0 | — | — |
| PRI-223 | measured | 0.04 | 1 | 1 | 10 | 0 | 0 | 1 |
| PRI-222 | measured | 0 | 4 | 0 | 2 | 1 | 0.5 | 0.5 |
| PRI-234 | measured | 0.25 | 2 | 1 | 3 | 1 | 0.3333 | 1 |
| PRI-228 | measured | 0.25 | 1 | 1 | 1 | 0 | 0 | 1 |
| PRI-229 | no_ground_truth | — | 0 | 0 | 0 | 0 | — | — |
| PRI-235 | measured | 0.5 | 3 | 2 | 4 | 0 | 0 | 1 |
| PRI-236 | measured | 0 | 2 | 0 | 0 | 0 | — | 0 |
| PRI-237 | measured | 0 | 3 | 0 | 0 | 0 | — | 0 |
| PRI-238 | measured | 0 | 3 | 0 | 0 | 0 | — | 0 |
| PRI-239 | measured | 0.1667 | 4 | 1 | 4 | 0 | 0 | 1 |
| PRI-241 | measured | 0.5 | 2 | 1 | 1 | 0 | 0 | 0.5 |
| PRI-242 | measured | 0.5 | 3 | 1 | 1 | 0 | 0 | 0.6667 |
| PRI-243 | measured | 0 | 2 | 0 | 0 | 0 | — | 0 |
| PRI-245 | measured | 0.3333 | 4 | 3 | 2 | 0 | 0 | 0.75 |
| PRI-246 | empty_core_denominator | — | 3 | 0 | 0 | 0 | — | 0 |
| PRI-249 | measured | 0.3333 | 2 | 1 | 1 | 0 | 0 | 1 |
| PRI-250 | measured | 0.5 | 2 | 1 | 0 | 0 | — | 0.5 |
| PRI-251 | measured | 0 | 2 | 0 | 3 | 0 | 0 | 0 |
| PRI-252 | measured | 0.3333 | 3 | 1 | 1 | 1 | 1 | 0.6667 |
| PRI-247 | measured | 0.1667 | 1 | 1 | 0 | 0 | — | 1 |
| PRI-248 | measured | 0.3333 | 2 | 1 | 1 | 0 | 0 | 1 |
| PRI-254 | empty_core_denominator | — | 2 | 0 | 0 | 0 | — | 0 |
| PRI-255 | measured | 0.3333 | 3 | 1 | 3 | 0 | 0 | 1 |
| PRI-256 | measured | 0.4 | 2 | 2 | 1 | 0 | 0 | 1 |
| PRI-257 | measured | 0.08333 | 2 | 1 | 1 | 0 | 0 | 1 |
| PRI-258 | measured | 0.25 | 1 | 1 | 1 | 0 | 0 | 1 |
| PRI-259 | measured | 0 | 2 | 0 | 0 | 0 | — | 0 |
| PRI-260 | measured | 0.5 | 3 | 2 | 1 | 0 | 0 | 1 |
| PRI-261 | measured | 0.5 | 4 | 1 | 1 | 1 | 1 | 0.75 |
| PRI-262 | no_ground_truth | — | 0 | 0 | 0 | 0 | — | — |
